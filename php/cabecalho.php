...
<head>
    ...
    <link rel="stylesheet" href="/Programador-Web-2/css/style.css">
...
<body>
    <header>
        <nav>
            ...
            <a href="/Programador-Web-2/php/formulario.php">Formulário</a>
            <a href="/Programador-Web-2/php/poo.php">POO</a>
            <?php if ($login) : ?>
